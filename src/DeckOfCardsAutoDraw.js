...
const DeckOfCardsAutoDraw = () => {
    ...
    useEffect ( () =>{     
        ...
        if (drawCard){
        intID.current = setInterval( async function autoDrawCard(){
            await getCard()
        }, 500)}

        return () => {
            // console.log(intID, "INTIDD")
...
export default DeckOfCardsAutoDraw;